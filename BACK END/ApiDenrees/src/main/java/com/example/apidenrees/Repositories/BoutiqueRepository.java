...
public interface BoutiqueRepository extends JpaRepository<Boutiques, Long> {
    ...
    Boutiques findBoutiquesByQuartier(@Param("quartier") String quartier);
    ...
    Boutiques findBoutiqueByVilleQAndQuartier(@Param("ville")  String ville, @Param("quartier") String quartier);
}
